...
<head>
	...
	<div style="background-image: url('tracker.jpeg');" >
	<style>
body {
...
<body>
	...
	<div class="row">
			<h2 align="center">Flight Price Prediction</h2>
	<hr />
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-7">
			<div class="login-panel panel panel-default">
				<div class="panel-heading" style="font-size:20px; background-color:blue ; color:white " align="center">Log in</div>
