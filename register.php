...
<head>
	...
	<div style="background-image: url('expense.jpg');" >
...
<body>
	...
	<hr />
		<div class="col-xs-12 col-xs-offset-3 col-sm-8 col-sm-offset-6 col-md-6 col-md-offset-6">
			<div class="login-panel panel panel-default">
				<div class="panel-heading"  style="font-size:20px; background-color:blue ; color:white " align="center">Sign Up</div>
